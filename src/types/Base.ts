 ...
 */
export type KeyJson = EntityJson & {
  /**
 ...
 */
export type EntityJson = GraphObjectJson & {
  /**
 ...
 */
export interface GraphObjectJson {
  /**
   * Named tags assigned to the entity (i.e., 'tag.Name', 'tag.OtherName')
   *
   * This interface was referenced by `GraphObjectJson`'s JSON-Schema definition
 ...
 */
export type RecordEntityJson = GraphObjectJson & {
  /**
   * Name of this entity
   */
  name: string;
 ...
 */
export type DataStoreJson = EntityJson & {
  /**
 ...
 */
export type FindingJson = RecordEntityJson & {
  /**
